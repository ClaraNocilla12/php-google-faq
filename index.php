    ...
    <header>
        <div class="container-fluid">
            <div class="d-flex pt-3">
                 <img class="ps-2 logo pt-1" src="./googlelogo.png" alt="">
                 <h4 class="text-secondary  ps-1">Privacy e Termini</h4>
            </div>
        </div>
    </header>
        ...
        <?php
             foreach($faqs as $QnA){
                ...
                foreach($QnA as $key => $content){
                    ...
                    if($key == 'question'){ ?>
                    <h3 class="my-3 pt-3 pb-2"> <?php   echo   $content ; ?> </h3> <?php
                    }else{ ?>
                     <p class=" pb-3 fw-light">  <?php echo  $content ; ?> </p> <?php
                    }
